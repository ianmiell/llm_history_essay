...
task1 = Task(
    ...
    expected_output="""A sumary of key points to research in 1000 words.""",
    agent=researcher,
    llm=agent_llm,
)

task2 = Task(
    description="""Using the insights provided, write a summary of information useful to an undergraduate historian tasked with writing an essay on this topic.""",
    expected_output="""A sumary of key points to write about in 1000 words.""",
    agent=writer,
    llm=agent_llm,
)
