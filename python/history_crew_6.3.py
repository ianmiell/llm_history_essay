...
lecturer = Agent(
    ...
    goal="Help a Junior Historian answer the question 'How did new liberalism differ from old liberalism'",
...
student = Agent(
    ...
    goal="Perform research to answer the question: 'How did new liberalism differ from old liberalism?",
